...
### Образование
Высшее экономическое, бакалавр экономики
<hr>
...
Внутренний проект с огромным legacy (React + Cordova).
Сделал roadmap по переходу на React Native. 
Переработал схему деплоя и git flow. 
Ускорил сборку проекта в 2 раза.
Также занимался поддержкой и разработкой фич.
Команда 6 человек.
